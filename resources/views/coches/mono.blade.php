...
<div id="wrap" class="d-none d-sm-none d-md-block">
    <div class="text-center mb-5">
        <h1 class="text-center" id="titulo1">Monovolúmenes</h1>
    </div>
    <form class="form ml-auto" method="GET" action="{{ route('coches.mon') }}" id="form1">
    ...
    <div id="main" class="container clear-top text-center w-50 mx-auto">
        @forelse ($coches as $coch)
                ...
                @empty
                <h3 class="text-center mb-5">No hay <b>monovolúmenes</b> de la marca seleccionada</h3>
                <br><br>
@endforelse
</div>
</div>
