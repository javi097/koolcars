...
<div id="wrap" class=" d-none d-sm-none d-md-block">
    <div class="text-center mb-5">
        <h1 class="text-center" id="titulo1">Familiares</h1>
    </div>
    <form class="form ml-auto" method="GET" action="{{ route('coches.fami') }}" id="form1">
    ...
    <div id="main" class="container clear-top text-center w-50 mx-auto">
        @forelse ($coches as $coch)
                ...
                @empty
                <h3 class="text-center mb-5">No hay <b>familiares</b> de la marca seleccionada</h3>
                <br><br>
@endforelse
</div>
</div>
...
<div id="wrap" class=" d-block d-sm-block d-md-none">
    ...
    <form class="form mx-auto ml-auto" method="GET" action="{{ route('coches.fami') }}" id="form1">
        <div class="form-row mt-3">
            <div class="col">
                <select name="marca_id" class="form-control">
                    <option>Seleccione la marca</option>
